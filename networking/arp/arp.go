...
func logDebugDefault(format string, a ...interface{}) {
}

func logErrorDefault(format string, a ...interface{}) {
}

func logInfoDefault(format string, a ...interface{}) {
}

func init() {
	logDebug = logDebugDefault
	logError = logErrorDefault
	logInfo = logInfoDefault
}

// SetupLog sets up the logging for this subpackage
// otherwise there is no logging.
func SetupLog(debuglog log, errorlog log, infolog log) {
	if debuglog != nil {
		logDebug = debuglog
	}
	if errorlog != nil {
