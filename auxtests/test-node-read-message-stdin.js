...
var run = function(){
	...
	setInterval(function(){
		console.log("**TEST " + n + "** (test-node-read-config-stdin.js)",config,"like",process.argv[2]);
		console.error("**TEST (stderr)" + n + "** (test-node-read-config-stdin.js)",config,"like",process.argv[2]);
		n++;
	},1000)	
}
