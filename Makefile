...
LDFLAGS += -L$(GREASE_GO_SRC)/deps/build/lib $(GREASE_GO_SRC)/deps/build/lib/libuv.a $(GREASE_GO_SRC)/deps/build/lib/libre2.a -ldl -Wl,-whole-archive deps/build/lib/libtcmalloc.a -Wl,-no-whole-archive

STATIC_LIB_FLAGS= deps/build/lib/libuv.a deps/build/lib/libre2.a -ldl -Wl,-whole-archive deps/build/lib/libtcmalloc.a -Wl,-no-whole-archive
